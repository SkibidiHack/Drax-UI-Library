local UserInterface = loadstring(game:HttpGet("https://raw.githubusercontent.com/SkibidiHack/Drax-UI-Library/main/Roblox.lua"))()
local Interface = UserInterface:Create{title = 'drax<font color="rgb(168, 157, 159)">.lib</font>',}

local tab1 = Interface:Tab( "Example Tab" )
local tab2 = Interface:Tab( "Example Config Tab" )
